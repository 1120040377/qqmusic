...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Home__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Play__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_PlayingList__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__state__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mutations__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__getters__ = __webpack_require__(114);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._l((_vm.mylyric), function(v, k) {
    return (k < 3) ? _c('p', {
      staticClass: "lyric-item"
    }, [_vm._v(_vm._s(v))]) : _vm._e()
  }), _vm._v(" "), _c('p', {
    staticClass: "lyric-item"
  }, [_vm._v(_vm._s(_vm.currentLyric(_vm.getCurrentTime)))])], 2)
},staticRenderFns: []}
...
if (browser) {
  window.Swiper = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["default"] = {
	...
	data: function data() {
		return {
			audioBtn: __webpack_require__(5),
			playImg: __webpack_require__(5),
			pauseImg: __webpack_require__(11),
			pauseBtn: true
		};
	},
	...
	methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_vuex__["a" /* mapActions */])(['pause']), {
		...
		updateTime: function updateTime() {
			this.$store.commit('updateCurrentTime', document.getElementById('music').currentTime.toFixed(2));
			this.$store.commit('updateDuration', document.getElementById('music').duration.toFixed(2));
		}
	}),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Recommand__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Rank__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_base64__ = __webpack_require__(117);
...
/* harmony default export */ __webpack_exports__["default"] = {
	...
	updated: function updated() {
		...
		this.$store.dispatch('getLyric', this.musicId).then(function (res) {
			_this.lyric = __WEBPACK_IMPORTED_MODULE_2__utils_base64__["a" /* default */].decode(res.data.lyric).split('[').slice(5).map(function (str) {
				var t = str.split(']');
	...
	watch: {
		...
		mylyric: function mylyric() {
			if (this.mylyric.length > 3) {
				this.mylyric = this.mylyric.slice(0, 3);
			}
		}
	},
	computed: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_vuex__["b" /* mapGetters */])(['getMusic', 'getCurrentTime'])),
	methods: {
		currentLyric: function currentLyric(time) {
			if (this.time != time) {
				this.time = time;
				if (this.lyric != null) {
					var num = time.split(':').reduce(function (a, b) {
						return a * 60 + parseInt(b);
					});

					if (this.lyric[num] != '\n' && this.lyric[num]) {
						for (var i = 0; i <= this.mylyric.length; i++) {
							this.mylyric.unshift(this.lyric[num]);
							if (this.mylyric[i] == this.lyric[num]) {
								break;
							}
						}
					}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Lyric__ = __webpack_require__(45);
...
/* harmony default export */ __webpack_exports__["default"] = {
	...
	data: function data() {
		return {
			...
			playImg: __webpack_require__(5),
			pauseImg: __webpack_require__(11),
			likeUrl: __webpack_require__(33),
			shangyiquUrl: __webpack_require__(39),
			listUrl: __webpack_require__(34),
			xiayiquUrl: __webpack_require__(41)
		};
	},
...
/* harmony default export */ __webpack_exports__["default"] = {
  data: function data() {
    return {
      playList: [],
      buttonImage: [__webpack_require__(28), __webpack_require__(27), __webpack_require__(29)]
    };
  },
...
/* harmony default export */ __webpack_exports__["default"] = {
	...
	data: function data() {
		return {
			...
			searchRes: null,
			hotkey: null,
			searchUrl: __webpack_require__(38)
		};
	},
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectDestructuringEmpty__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__types__ = __webpack_require__(21);
...
/* harmony default export */ __webpack_exports__["a"] = _types$SEARCH_SHOW$ty = {}, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$SEARCH_SHOW$ty, __WEBPACK_IMPORTED_MODULE_1__types__["a" /* SEARCH_SHOW */], function (state) {
	state.searchShow = true;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$SEARCH_SHOW$ty, __WEBPACK_IMPORTED_MODULE_1__types__["b" /* SEARCH_HIDE */], function (state) {
	state.searchShow = false;
}), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_defineProperty___default()(_types$SEARCH_SHOW$ty, __WEBPACK_IMPORTED_MODULE_1__types__["c" /* PAUSE */], function (state) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_resource__ = __webpack_require__(22);
...
//# sourceMappingURL=app.4a5cc6089d48b5659aa2.js.map